      ...
      <form className="pt-9 ps-9 px-70 container py-8 justify-center items-center width:180px">
        <div className="space-y-12 bg-transparent">
          <div className="border-b border-white/10 pb-4">
            <h1 className="text-base/7 font-semibold text-white text-center w-120">
            ...
            <div className="mt-2">
              <div className="flex items-center rounded-md bg-white/5 pl-3 outline-1 -outline-offset-1 outline-white/10 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-500">
                <input
                  ...
                  maxLength={16}
                  type="text"
                  placeholder="Masukan angka (16 digit)"
                  className="block min-w-0 grow bg-transparent py-1.5 pr-3 pl-1 text-base text-white placeholder:text-gray-500 focus:outline-none sm:text-sm/6 max-length:16"
                  required
                />
              </div>
            </div>
